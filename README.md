...
## 🎯 Repository Overview
The goal of this collection is purely **educational and outreach-oriented**. It aims to bridge the gap between complex mathematical abstractions and intuitive understanding in the field of **Deep Learning**. While the main video project also discusses Physics-Informed Neural Networks (PINNs), this repository focuses primarily on the **visual building blocks of Neural Networks** and their underlying algorithms.

I have decided to open-source these scripts to help students, researchers, and educators create similar visualizations for their own academic or dissemination purposes.

## 🎓 Academic Context
* **Institution:** Politecnico di Milano
* **Degree:** B.Sc. in Mathematical Engineering
* **Purpose:** Final Project for the Bachelor's Degree
* **Topics Covered:** Neural Networks theory (**Backpropagation**, **Gradient Descent**, **Universal Approximation Theorem**) and an introduction to **Physics-Informed Neural Networks (PINNs)**.
