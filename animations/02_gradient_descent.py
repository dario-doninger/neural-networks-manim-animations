...
class GradientDescent3D(ThreeDScene):
    def construct(self):
        ...
        # 2. COST FUNCTION SURFACE & 360 CAMERA ROTATION
        ...
        # 7. LEARNING RATE EXTENSION & UPDATE FORMULA
