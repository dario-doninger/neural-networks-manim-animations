...
class SingleNeuronFunction(Scene):
    def construct(self):
        ...
        # 1. RETURN TO NORMAL & REMOVE VECTORS
        ...
        # 2. ZOOM SELECTION AND SMOOTH TRANSFORM
        ...
        # 3. WEIGHTS AND SPACIOUS PERCENTAGES
        ...
        # 5. REVEAL & DE-ZOOM WITH VERTICAL DROP
        ...
        # 6. ISOLATE Z AND ACTIVATION FUNCTION
